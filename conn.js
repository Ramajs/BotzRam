...
conn.sendMessage(from, { text: "*Haii kak*, kamu belum terdaftar di database bot, silahkan klik button *Verify* untuk memverifikasi.", buttons:[{buttonId: "#verify", buttonText:{displayText:"Verify"}, type:1}], footer: `${botName} © 2022`}, { quoted: fkontak }) 
...
*╰►* JASA PROMOSI BOT "20K"
 https://wa.me/6285791220179

*╰►*  SEWA BOT PERMANEN "20K"
 https://wa.me/6285791220179

*╰►* JUAL NOKOS WHATSAP  "5k"
https://wa.me/6285791220179
...
var bg_lexxy = '6285791220179@s.whatsapp.net'
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by Ramaa Gnnz' })
}
console.log(feta)
}
break
